...
import { X, Save, Building2, User, Mail, Phone, MapPin, FileText, CreditCard, AlertTriangle, CheckCircle, Clock, Calendar, Plus, History } from 'lucide-react';
import ChangelogEditor from '../projects/ChangelogEditor';
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-5xl max-h-[90vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {activeTab === 'changelog' && project._id && (
            <div>
              <ChangelogEditor
                projectId={project._id}
                onUpdate={() => {
                  // Frissítjük a projektet, hogy látszódjon a changelog változása
                  onUpdate({...project});
                }}
              />
            </div>
