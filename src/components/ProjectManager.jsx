...
const [projects, setProjects] = useState([]);
  ...
  const handleCreateInvoice = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://38.242.208.190:5001/api/projects/${selectedProject._id}/invoices`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
                ...
                onClick={async () => {
                  try {
                    const url = selectedProject._id
                      ? `http://38.242.208.190:5001/api/projects/${selectedProject._id}`
                      : 'http://38.242.208.190:5001/api/projects';
